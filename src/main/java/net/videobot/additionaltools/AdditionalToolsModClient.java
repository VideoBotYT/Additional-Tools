...
@EventBusSubscriber(modid = AdditionalToolsMod.MODID, value = Dist.CLIENT)
public class AdditionalToolsModClient {
    public AdditionalToolsModClient(ModContainer container) {
